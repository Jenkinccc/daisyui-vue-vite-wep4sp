<template>
  <div class="flex mt-4 justify-around">
    <div class="flex avatar online">
      <div class="w-10 h-10 rounded-full">
        <img src="/resource/407f2xl.png" />
      </div>
    </div>
    <div class="flex">
  ...
  <div class="hero min-h-screen bg-base-200">
    <div class="hero-content flex-col lg:flex-row-reverse">
      <img
        src="/resource/portrait.webp"
        class="mask mask-squircle max-w-sm rounded-lg shadow-2xl"
      />
      <div>
        ...
        <svg class="iconpark-icon"><use href="#github-one"></use></svg>
      </div>
    </div>
  </div>
</template>
